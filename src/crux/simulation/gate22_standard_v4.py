...
def main() -> int:
    ...
    base_spec = base.with_overrides(dict(V4_OVERRIDES))
    ...
    print("\n=== standard-suite qualification for v4 (selection-era seeds 101-132) ===")
    ...
    for left, right in (("baseline-v1", "candidate-v4"),):
