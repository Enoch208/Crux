...
OUTPUT_PATH = Path("evidence-dev/qualification_powered.jsonl")
RUN_ID = "dev-qualify-2"
BASELINE_VERSION = "baseline-v1"
CANDIDATE_VERSION = "candidate-v2"
SWEEP_SEEDS = tuple(range(101, 117))
HELDOUT_SEEDS = tuple(range(301, 333))
NOMINAL_SEED = 301
MAX_CHUNKS = 900
...
def main() -> int:
    assert_heldout_uncontaminated(HELDOUT_SEEDS, SWEEP_SEEDS)
    ...
    print("\n=== powered held-out qualification ===")
